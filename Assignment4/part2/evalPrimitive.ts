...
import { Value, isSymbolSExp, isCompoundSExp, makeCompoundSExp, makeEmptySExp, isEmptySExp, CompoundSExp, EmptySExp, SExpValue, makeTuple } from "./L5-value";
import { Result, makeFailure, makeOk } from "../shared/result";
import { allT, first, rest } from "../shared/list";
import { isNumber, isString, isBoolean } from "../shared/type-predicates";
import { reduce, map, isEmpty } from "ramda";
...
const valuesPrim = (vals: Value[]) : Result<Value> | Result<Value[]> =>
       vals.length === 0 ? makeFailure("vals of values primOp cannot be 0") : 
